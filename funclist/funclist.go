...
func GetFunc(name string) []func() {
	...
	gormfunc := []func(){
		...
		mygorm.GormSample018,
		mygorm.GormSample019,
		mygorm.GormSample020,
		mygorm.GormSample021,
		mygorm.GormSample022,
		mygorm.GormSample023,
		mygorm.GormSample024,
		...
		mygorm.GormSample033,
		mygorm.GormSample034,
		mygorm.GormSample035,
		mygorm.GormSample036,
		mygorm.GormSample037,
	}
	goroutinefunc := []func(){
